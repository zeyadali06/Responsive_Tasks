        ...
        Row(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(color: Colors.black.withOpacity(.03), borderRadius: BorderRadius.circular(50)),
              child: Transform.rotate(angle: -(pi / 4), child: const Icon(Icons.nightlight_outlined, size: 18, color: Color(0xff1d1d1d))),
            ),
            ...
            Container(
              ...
              alignment: Alignment.center,
              decoration: BoxDecoration(color: Colors.black.withOpacity(.03), borderRadius: BorderRadius.circular(50)),
              child: const Icon(Icons.add_alert_outlined, size: 20, color: Color(0xff1d1d1d)),
            ),
